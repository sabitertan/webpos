...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_webpos_builder'] = $this->language->get('text_webpos_builder');
		...
		$data['webpos_builder'] = $this->url->link('extension/webposbuilder', 'token=' . $this->session->data['token'], 'SSL');
